 ...
 */
Ext.define('Strevusproto.view.search.TweetListItem', {
    extend: 'Ext.dataview.component.DataItem',
    xtype : 'tweetlistitem',
    requires: [
        'Strevusproto.view.search.TweetListItemText',
        'Ext.Img'
    ],
    ...
    applyText: function(config) {
        return Ext.factory(config, Strevusproto.view.search.TweetListItemText, this.getText());
    },
