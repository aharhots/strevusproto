/**
 * @class Strevusproto.controller.phone.Main
 ...
 * is provided by the Strevusproto.controller.Main superclass, but we do need to add a couple of refs and control
 ...
 *
 */
Ext.define('Strevusproto.controller.phone.Main', {
     ...
     * 'nav/:id', so is called automatically whenever the user navigates back or forward between Navigations.
